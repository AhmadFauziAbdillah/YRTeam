            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="glass-card rounded-2xl p-6 slide-up" style="animation-delay: 0.4s;">
                        ...
                        <div class="space-y-3">
                            <a href="https://wa.me/62859106545737" target="_blank" class="w-full flex items-center gap-3 px-4 py-3 bg-green-500 hover:bg-green-600 text-white rounded-xl transition">
