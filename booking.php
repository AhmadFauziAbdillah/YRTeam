    ...
    <div class="p-4 lg:p-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="service-card glass-card rounded-2xl p-6 slide-up" style="animation-delay: 0.2s;" data-service="tuning">
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">Tuning Lengkap</h3>
                        <p class="text-slate-400 text-sm mb-4">Tuning komprehensif untuk performa maksimal</p>
                        <div class="text-2xl font-bold text-purple-400">Rp <?php echo number_format($servicePrices['tuning'], 0, ',', '.'); ?></div>
                    </div>
                </div>

                <div class="service-card glass-card rounded-2xl p-6 slide-up" style="animation-delay: 0.3s;" data-service="maintenance">
                    <div class="text-center">
                        <div class="w-16 h-16 bg-green-500 bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                            <svg class="w-8 h-8 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 .724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2">Maintenance</h3>
                        <p class="text-slate-400 text-sm mb-4">Servis rutin dan perawatan berkala</p>
                        <div class="text-2xl font-bold text-green-400">Rp <?php echo number_format($servicePrices['maintenance'], 0, ',', '.'); ?></div>
                    </div>
                </div>
            </div>
